...
class FlightTab(Tab, flight_tab_class):
    ...
    def _mag_data_received(self, data):                 
        ...
        magn_ellipsoid_center = [-81.2307, -380.031, 163.942]
        magn_ellipsoid_transform = [[0.836050, 0.00978915, 0.0202166], [0.00978915, 0.863648, -0.00679250], [0.0202166, -0.00679250, 0.997277]]
