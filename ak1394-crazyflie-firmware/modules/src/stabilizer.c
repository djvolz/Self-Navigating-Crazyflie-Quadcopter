...
#define ALTIMETER_MODE_PRESSURE 1
#define ALTIMETER_MODE_TEMPERATURE 2
uint8_t altMode = ALTIMETER_MODE_PRESSURE;

PRIVATE int16_t magHeadingX;
PRIVATE int16_t magHeadingY;
PRIVATE int16_t magHeadingZ;
...
LOG_GROUP_START(altimeter)
LOG_ADD(LOG_FLOAT, pressure, &pressure)
LOG_ADD(LOG_FLOAT, temperature, &temperature)
LOG_GROUP_STOP(altimeter)

LOG_GROUP_START(mag)
LOG_ADD(LOG_INT16, x, &magHeadingX)
LOG_ADD(LOG_INT16, y, &magHeadingY)
LOG_ADD(LOG_INT16, z, &magHeadingZ)
LOG_GROUP_STOP(mag)
